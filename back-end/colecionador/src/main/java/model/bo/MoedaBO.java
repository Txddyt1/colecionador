...
public class MoedaBO {
	...
	private byte[] converterByteParaArray (InputStream inputStream) throws IOException {
     ...
     public MoedaVO cadastrarMoedaBO(InputStream fileInputStream, FormDataContentDisposition fileMetaData, InputStream moedaInputStream) {
	...
	public Response listarMoedasBO() {
		MoedaDAO moedaDAO = new MoedaDAO();
		ArrayList<MoedaVO> listaMoedasVO = moedaDAO.listarTodasMoedasDAO();
