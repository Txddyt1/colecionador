...
public class MoedaVO {
    ...
    public MoedaVO(int idMoeda, UsuarioVO usuario, int idUsuario, String nome, String pais, int ano, BigDecimal valor, String detalhes, LocalDate dataCadastroMoeda, byte[] imagem) {
        super();
